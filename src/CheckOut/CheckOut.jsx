...
const CheckOut = ({ title, price, rating, image, id }) => {
  ...
  return (
    <div className="flex flex-wrap justify-center items-center border-2 bg-gray-50 m-9 ">
      <div className="flex justify-center items-center w-4/5">
        <img src={image} alt="" className="w-70 h-40 p-4" />
        <div>
          ...
          <button
            onClick={removeItem}
            className="bg-black rounded-md p-2 text-white m-1"
          >
            Remove Item
          </button>
        </div>
